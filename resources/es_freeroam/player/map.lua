local blips = {
   ...
   {name="Barber", id=71, x=-285.238, y=6236.365, z=31.455},
    ...
    {name="Champs de Cannabis", id=140, x=2208.777, y=5578.235, z=53.735},
    -- {name="Traitement de Cannabis", id=140, x=-180.0000, y=6400.0000, z=31.735},
    -- {name="Dealer de Cannabis", id=140, x=86.0000, y=-1954.0000, z=20.735},
    {name="Champs de Coca", id=214, x=1930.745, y=4870.326, z=46.92},
    {name="Traitement de Coca", id=214, x=-2217.27, y=3482.4, z=30.16},
    {name="Dealer de Coke", id=214, x=1219.47, y=-2920.93, z=5.86},
